...
<footer class="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 mt-40 bg-gradient-to-r from white via-indigo-200/60 to-white">
    <div class="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
        <a href="https://prebuiltui.com">
            <img src='/src/assets/logo.svg' alt='logo' className='h-9 w-auto'/>
        </a>
        <div>
        ...
        <div>
            <p class="text-slate-800 font-semibold">Legal</p>
            <ul class="mt-2 space-y-2">
    ...
    <div class="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
        ...
        <p class="mt-3 text-center">© 2026 <a href="https://prebuiltui.com">Resume Builder</a></p>
    </div>
</footer>
    </div>
  )
